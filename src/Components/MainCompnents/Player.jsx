...
function Player(){
  ...
  function StreamingAudioPlayer() {
    ...
    return (
      <audio id="audioBtn"  className="audioBtn"  preload="auto">
  ...
  .catch((error) => {
    console.log(error);
     ...
     config = {
        method: 'get',
        maxBodyLength: Infinity,
        url: 'https://www.googleapis.com/youtube/v3/videos?part=snippet&type=video&videoEmbeddable=true&key=AIzaSyB_wVUnTgR8ZDVUHyrw5YZ5zme9oVKIeow&id='+sessionStorage.getItem("video_id"),
        headers: { }
      };
    axios.request(config)
  .then((response) => {
  ...
  <div id="player02" className="player horizontal">
      ...
      <StreamingAudioPlayer/>
        ...
        <div className="controls">
          ...
          <div className="play" onClick={initAudio}>
            <svg
              width={30}
              height={30}
              viewBox="0 0 30 30"
